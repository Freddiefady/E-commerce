            ...
            <li class="nav-item"><a href=""><i class="la la-dashboard"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title"
                        ...
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="navbar-semi-dark.html"
                                    data-i18n="nav.navbars.nav_semi">Navbar
                                    Semi Dark</a>
                            </li>
                    ...
                    <li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title"
                        ...
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="#"
                                ...
                                <ul class="menu-content">
                                    <li><a class="menu-item"
                                            href="{{ asset('assets/dashboard') }}//rtl/vertical-modern-menu-template/layout-content-detached-left-sidebar.html"
                                            data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_left_sidebar">Detached
                                            left sidebar</a>
                                    </li>
                                    <li><a class="menu-item"
                                            href="{{ asset('assets/dashboard') }}//rtl/vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html"
                                            data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_left_sidebar">Detached
                                            sticky left sidebar</a>
                                    </li>
                                    <li><a class="menu-item"
                                            href="{{ asset('assets/dashboard') }}//rtl/vertical-modern-menu-template/layout-content-detached-right-sidebar.html"
                                            data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_right_sidebar">Detached
                                            right sidebar</a>
                                    </li>
                                    <li><a class="menu-item"
                                            href="{{ asset('assets/dashboard') }}//rtl/vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html"
                            ...
                            <li><a class="menu-item"
                                    ...
                                    data-i18n="nav.starter_kit.fixed_navigation">Fixed
                                    navigation</a>
                            </li>
                            <li><a class="menu-item"
                    ...
                    <li class="disabled nav-item"><a href="#"><i class="la la-eye-slash"></i><span class="menu-title"
                                data-i18n="nav.disabled_menu.main">Disabled
                                Menu</span></a>
                    </li>
