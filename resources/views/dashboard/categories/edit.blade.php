                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="">{{__('dashboard.edit_category')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="eventRegInput1" name="name[en]" class="form-control"
                                            value="{{$category->getTranslation('name', 'en')}}" placeholder="{{__("auth.name_en")}}" >
                                            @error('name[en]')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="eventRegInput1" name="name[ar]" class="form-control"
                                            value="{{$category->getTranslation('name', 'ar')}}" placeholder="{{__("auth.name_ar")}}" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                <input type="radio" value="1" @checked($category->status == 'Active') name="status" class="custom-control-input" id="yes1">
                                                <label for="yes1" class="custom-control-label">{{__('dashboard.active')}}</label>
                                            </div>
                                            <div class="d-inline-block custom-control custom-radio">
                                                <input type="radio" value="0" @checked($category->status == 'Inactive') name="status" class="custom-control-input" id="no1">
